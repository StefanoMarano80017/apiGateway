...
public class RouteService {
    ...
    public Flux<RouteDefinitionEntity> getAll() {
        return this.routeRepository.findAll();
    }

    public Mono<RouteDefinitionEntity> create(RouteDefinitionEntity apiRoute) {
        Mono<RouteDefinitionEntity> route = this.routeRepository.save(apiRoute);
        return route;
    }

    public Mono<RouteDefinitionEntity> getById(String id) {
